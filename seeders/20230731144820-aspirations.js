...
for (let i = 1; i <= 25; i++) {
  const judul = `${faker.helpers.arrayElement(arrMasalahJudul)} ${fakerID_ID.location.streetAddress()}`
  aspirations.push({
    judul: judul,
    ...
    user_id: null,
    createdAt: faker.date.between({from: '2023-05-01T00:00:00.000Z', to: '2023-07-31T00:00:00.000Z'}),
    updatedAt: new Date(),
  })
}
